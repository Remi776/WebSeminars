...
$work_experience = [
    [
            ...
            'description' => 'Какие-то штуки что-то там ну делаю ну куда-то что-то парсить вот такое слово знаю, еще это ну в общем а я и не знаю даже чем занимается junior вот.',
        ],
        [
            'position' => 'Уборщик',
            'date' => 'Nov 2020 - Nov 2021',
            'description' => 'Вилкой чистил раз раз раз, снег убирал раз раз раз',
        ],
        [
            'position' => 'Викинг / набеги',
            'date' => 'Jun 793 - Nov 900',
            'description' => 'Просто недавно досмотрел "Последнее королевство", очень клевый сериал, советую. Как альтернатива "Викингам"',
        ]
];
?>
<!DOCTYPE html>
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?=$work_experience[$i]['position']?></b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?=$work_experience[$i]['date']?></h6>
